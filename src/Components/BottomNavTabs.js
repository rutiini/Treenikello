...
class BottomNavTabs extends Component {
  ...
  render() {
    ...
    return (
      ...
      <ActionsMenuBar title={tabLabels[this.state.value]} exercises={exercises} selectedExerciseIndex={selectedExerciseIndex} setTime={setTime}/>
      <SwipeableViews
          ...
          remove={removeSection} /></TabContainer>
